...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { released_at: @release.released_at, version: @release.version }
    end
  ...
  test "should update release" do
    patch :update, id: @release, release: { released_at: @release.released_at, version: @release.version }
    assert_redirected_to release_path(assigns(:release))
  end
